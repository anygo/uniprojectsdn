...
/**
 * Class extending VisualBarDiagram to display MFCC values from a buffered audio
 * source. Attributes of the window being used for FFT may be changed here.
 * 
 * @author Matthias Ring, Markus Goetze
 * 
 */
public class VisualMFCCDiagram extends VisualBarDiagram implements
		FrameListener {
	 ...
	 *            Title to be used
	 */
	public VisualMFCCDiagram(String title) {
		super(title);
	}
	...
	public void update() throws Exception {
		...
		DCT dct = new DCT(melfilter, false);
		frameSource = dct;
