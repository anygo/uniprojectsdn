...
; stop_floppy_motor
;
; Stoppt den Motor der Floppy, da das BIOS dazu in Kuerze nicht mehr in
...
; print
;
; Gibt eine Zeichenkette aus, erwartet die Adresse in BP und die Anzahl der
; Zeichen in CX.
; 
print:
	push	ax
