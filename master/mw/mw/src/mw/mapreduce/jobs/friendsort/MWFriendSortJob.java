...
public class MWFriendSortJob implements MWJob {
	...
	public MWMapper createMapper(String inFile, int nMappers, int current, String tmpFileName) {
		...
		MWMapContext<String, String, String, String> context = 
			new MWMapContext<String, String, String, String>(inFile, current*stepSize, length, getComparator(), tmpFileName);
		
		
		MWMapper<String, String, String, String> m = new MWFriendSortMapper<String, String, String, String>();
	...
	public Comparator getComparator() {
		...
		return new ReverseStringComparator<String>();
	}
